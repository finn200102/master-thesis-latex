...
% Feature Kategorien Zeitbereich, Frequenz, nicht linear
...
Es werden alle Feature auf \(\mu = 0, \sigma = 1\) standardisiert.
% Python code ?

\subsection{Feature-Selektrion}

Die initiale Menge an Features von \(> 1000\) wurde systematisch reduziert, durch die Verwendung der univariaten Selektion. % Python code?

\subsection{Train-Test-Aufteilung}
Für die Modellvaliderung wurden verschiedene Strategien implementiert, die Verwendung von 20\% der Daten im Test-Datensatz, wobei jedoch viele Daten in den kleinen Datensätzen verlohren gehen. Die Verwedung der Kreuzvalidierung.
